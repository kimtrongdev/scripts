    ...
    app.get('/input', (req, res) => {
        ...
        if (process.platform === "win32") {
            ...
            if (req.query.action == 'TYPE') {
                ...
                execSync(`xdotool mousemove ${req.query.x} ${req.query.y} && sleep 1 && xdotool click --repeat 3 1 && sleep 2 && xdotool key Control_L+v && sleep 3 && xdotool key KP_Enter && sleep 1`)
            }
                ...
                execSync(`xdotool key Escape && sleep 0.5 && xdotool key Control_L+l && sleep 2 && xdotool type "${req.query.str}" && sleep 2 && xdotool key KP_Enter`)
            }
