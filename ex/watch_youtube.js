   ...
   // await sleep(1000)
    ...
    if(action.url_type == 'playlist') {
        ...
        if (randomVideoModeBtn) {
            console.log('randomVideoModeBtn');
            await userClick(action.pid,'randomVideoModeBtn', randomVideoModeBtn)
        }
        ...
        if (loopModeBtn) {
            console.log('loopModeBtn');
            await userClick(action.pid,'loopModeBtn', loopModeBtn)
        }
