      ...
      if (!editBtn) {
        ...
        if (editBtn) {
          ...
          if (selectorVN) {
            ...
            let saveBtn = getElementContainsInnerText('span', ['Simpan perubahan', 'Salvar alterações', 'Stoor veranderinge', 'बदलाव सेव करें'], '', 'equal') || document.querySelectorAll('div[role="button"]>div>div>div>span').item(2)
            if (saveBtn) {
