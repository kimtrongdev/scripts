...
function getElementPosition(el,iframe){
    if(el){
        ...
        let x = zoom*(pos.left + (pos.width*0.6) + (iframe?iframePost.left:0)) + screenX + menuLeftWith + (windowWide?((windowWide - menuLeftWith)-zoom*window.innerWidth)/2:0) + widthCustom
